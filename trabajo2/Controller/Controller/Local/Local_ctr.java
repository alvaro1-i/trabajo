...
public class Local_ctr {

	private static List<Local> list = new ArrayList<Local>();
	private static Local L = new Local();
	...
	public static void crear() {
		...
		try {
			System.out.println();
		   Logic.Local.logicLocal.newLoc(L);
	...
	private static Local pedirDatos() {
