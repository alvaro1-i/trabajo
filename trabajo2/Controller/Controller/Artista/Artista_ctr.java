...
public class Artista_ctr {

	private static List<Artista> list = new ArrayList<Artista>();
	private static Artista A = new Artista();
	...
	public static void crear() {
		...
		try {
			System.out.println();
		   Logic.Artista.LogicArtista.newArt(A);
